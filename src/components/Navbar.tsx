    ...
    <nav className="bg-white shadow-lg fixed w-full z-50">
        ...
        <div className="flex justify-between h-20">
          <div className="flex">
            <div className="flex-shrink-0 flex items-center">
              <span className="text-blue-600 font-bold text-2xl">Aqua Piscines Hérault</span>
            </div>
            <div className="hidden sm:ml-6 sm:flex sm:space-x-8">
              ...
              <a href="#piscines" className="border-transparent hover:border-gray-300 hover:text-gray-700 text-gray-500 inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium">
                Nos Piscines
              </a>
              <a href="#services" className="border-transparent hover:border-gray-300 hover:text-gray-700 text-gray-500 inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium">
                Nos Services
              </a>
              <a href="#contact" className="border-transparent hover:border-gray-300 hover:text-gray-700 text-gray-500 inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium">
                Contact
              </a>
            </div>
          </div>
      ...
      <div className={`sm:hidden ${isMenuOpen ? 'block' : 'hidden'}`}>
        <div className="pt-2 pb-3 space-y-1">
          ...
          <a href="#piscines" className="border-transparent text-gray-500 hover:bg-gray-50 hover:border-gray-300 hover:text-gray-700 block pl-3 pr-4 py-2 border-l-4 text-base font-medium">
            Nos Piscines
          </a>
